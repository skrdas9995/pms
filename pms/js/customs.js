...
(function($){
	...
	*/
	...
	$('#multiple-sticky-menu li').on("mouseenter", function() {
		$(this).find('ul').first().stop(true, true).delay(350).slideDown(500, 'easeInOutQuad');
	});
	// Mouse-leave dropdown
	$('#multiple-sticky-menu li').on("mouseleave", function() {
		$(this).find('ul').first().stop(true, true).delay(100).slideUp(150, 'easeInOutQuad');
	});
	...
	*/
		...
		var load = function(stickies) {
			...
			if (typeof stickies === "object" && stickies instanceof jQuery && stickies.length > 0) {
				...
				$stickies = stickies.each(function() {
					...
					var $thisSticky = $(this).wrap('<div class="" />');
	...
	$('#detailgallery').imagesGrid({
        ...
        images: [
            ...
            'images/top-destinations/01.jpg',
            { src: 'images/top-destinations/02.jpg', caption: 'The long way' },
            'images/top-destinations/01.jpg',
            'images/top-destinations/02.jpg',
            'images/top-destinations/01.jpg'
        ]
    });
